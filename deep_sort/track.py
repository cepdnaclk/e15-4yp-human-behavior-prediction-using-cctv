...
class Track:
    ...
    def __init__(self, mean, covariance, track_id, n_init, max_age, class_name, adc_threshold, detection_confidence, feature=None):
        self.mean = mean
        ...
        self.det_cls = class_name  # the class from detection
        self.counter = Counter()
        self.class_name = class_name  # for most common class
