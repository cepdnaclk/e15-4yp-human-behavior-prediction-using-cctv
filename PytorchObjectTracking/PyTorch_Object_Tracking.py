...
input_path  = '../Assets/Videos/common2.mp4'
    ...
    for img_name in tqdm(in_image_names):
        ...
        if detections is not None:
            ...
            for x1, y1, x2, y2, obj_id, cls_pred in tracked_objects:
                ...
                line_results = ",".join([str(int(frame_number)),str(int(obj_id)),str(int(x1)),str(int(y1)),str(int(box_w)),str(int(box_h)),"1,1,1"])
