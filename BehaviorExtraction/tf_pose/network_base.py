...
from BehaviorExtraction.tf_pose.common import to_str
...
_init_xavier = tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform")  # tf.initializers.GlorotNormal() 
_init_norm = tf.compat.v1.truncated_normal_initializer(stddev=0.01)   #tf.compat.v1.truncated_normal_initializer(stddev=0.01)
