...
def get_training_imgs_info(
    ...
    with open(valid_images_txt) as f:
        ...
        print("")
        print("Number of tf_action classes = {}".format(len(actions)))
        print("Number of training images = {}".format(cnt_image))
        print("Number of training images of each tf_action:")
...
class ReadValidImagesAndActionTypesByTxt(object):
    ''' This is for reading training images configured by a txt file.
        Each training image should contain a person who is performing certain type of tf_action.
    '''
    ...
    def __init__(self, img_folder, valid_imgs_txt,
        ...
        Arguments:
            ...
            valid_imgs_txt {str}: A txt file which specifies the tf_action labels.
                Example:
